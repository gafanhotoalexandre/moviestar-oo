                    ...
                    <form id="edit-movie-form" action="<?= BASE_URL ?>movie_process.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" id="title" class="form-control"
                                placeholder="Digite o título do filme" value="<?= $movie->title ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="category" id="category" class="form-control">
                                ...
                                <option value="Ação"
                                    <?= $movie->category === 'Ação' ? 'selected' : '' ?>>Ação</option>
                                <option value="Aventura"
                                    <?= $movie->category === 'Aventura' ? 'selected' : '' ?>>Aventura</option>
                                <option value="Animação"
                                    <?= $movie->category === 'Animação' ? 'selected' : '' ?>>Animação</option>
                                <option value="Comédia"
                                    <?= $movie->category === 'Comédia' ? 'selected' : '' ?>>Comédia</option>
                                <option value="Drama"
                                    <?= $movie->category === 'Drama' ? 'selected' : '' ?>>Drama</option>
                                <option value="Fantasia / Ficção"
                                    <?= $movie->category === 'Fantasia / Ficção' ? 'selected' : '' ?>>Fantasia / Ficção</option>
                                <option value="Romance"
                                    <?= $movie->category === 'Romance' ? 'selected' : '' ?>>Romance</option>
                            </select>
                        </div>
                        ...
                        <input type="submit" value="Atualizar" class="card-btn">
